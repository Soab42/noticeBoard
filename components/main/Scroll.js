  ...
  return (
    <div className="shadow-xl p-2 overflow-hidden text-[#178890]">
      <div className="text-justify h-8 text-lg whitespace-nowrap text-blue-100 headline w-full">
        স্বাগতম ! পল্লী মঙ্গল কর্মসূচি ‘পিএমকে‘ এর নোটিশ বোর্ড এ। এখানে সকল
        ...
        করুন। বর্তমানে সাইট টি নির্মানাধীন আছে। তাই সকল ফিচার কাজ নাও করতে পারে।
        যে কোন ধরনের পরামর্শ বা জিজ্ঞাসায় যোগাযোগ করুন ০১৬৪৪৫৫৬৫৪৩। ধন্যবাদ।
      </div>
    </div>
  );
}
